...
def index():
    ...
    return render_template('index.html', result_mem=result_mem, result_net_in=result_net_in, result_net_out=result_net_out, result_disk=result_disk, result_disk_read=result_disk_read, result_disk_write=result_disk_write, result_cpu=result_cpu,result_alerts=result_alerts, segment='index')
...
def update():
    ...
    return jsonify({
        ...
        'result_net_out2' : result_net_out[0][1],
